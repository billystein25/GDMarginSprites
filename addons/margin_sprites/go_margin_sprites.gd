...
func _enter_tree() -> void:
	...
	add_custom_type(MARGIN_SPRITES_TYPE_NAME, "RefCounted",
					preload(MARGIN_SPRITES_SCRIPT),
					preload(MARGIN_SPRITES_ICON))
...
func _exit_tree() -> void:
	remove_custom_type(MARGIN_SPRITES_TYPE_NAME)

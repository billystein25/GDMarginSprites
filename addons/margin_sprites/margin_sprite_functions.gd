...
static func _scale_mode(texture_size: Vector2, min_size: Vector2, max_size: Vector2) -> Vector2:
...
static func _smart_mode() -> Vector2:
	return Vector2.ONE

## Returns new scale 2d
static func overwrite_scale(

...
classes will respect your modification and will not overwrite it again. If you need for
whatever reason to force the overwrite algorithm to run you can call
force_overwrite_scale(). Which is the only public method in the classes.
